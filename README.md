...
```sh
$ tfperms internal/catalog/testdata/storage/google_storage_bucket
...
```sh
$ tfperms internal/catalog/testdata/storage/google_storage_bucket --by-resource
  6 permissions for 2 resources, 0 unknowns, 0 unresolved conditionals
...
```sh
$ tfperms internal/catalog/testdata/storage/google_storage_bucket --format=role --role-name=tf_pipeline
